...
abstract class Text extends Base
{
    ...
    protected function generateText(int $maxNbChars, array $words): string
    {
        $result = [];
        $resultLength = 0;
    ...
    protected function getConsecutiveWords(int $indexSize): mixed
    {
    ...
    protected static function explode(string $text): array
    {
        return explode(static::$separator, $text);
    }

    protected static function implode(array $words): string
    {
    ...
    protected static function validStart(string $word): bool|int
    {
        $isValid = true;
    ...
    protected static function appendEnd(string $text): mixed
    {
