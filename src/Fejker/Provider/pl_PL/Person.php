...
use Fejker\Provider\DateTime as FejkerDatetime;
 ...
 */
class Person extends \Fejker\Provider\Person
{
    protected static array $lastNameFormat = [
        '{{lastNameMale}}',
        '{{lastNameFemale}}',
    ];
    ...
    protected static array $title = ['mgr', 'inż.', 'dr', 'doc.'];
    ...
    public static function lastNameMale(): string
    {
        return static::randomElement(static::$lastNameMale);
    }

    public static function lastNameFemale(): string
    {
     ...
     */
    public static function pesel(?\DateTime $birthdate = null, string $sex = null): string
    {
        if ($birthdate === null) {
            $birthdate = FejkerDatetime::dateTimeThisCentury();
        }
     ...
     */
    public static function personalIdentityNumber(): string
    {
