...
class Base
{
    ...
    public static function passthrough($value): mixed
    {
        return $value;
    }
     ...
     */
    public static function randomElements(mixed $array = ['a', 'b', 'c'], ?int $count = 1, bool $allowDuplicates = false)
    {
        $elements = $array;
     ...
     * @throws \InvalidArgumentException
     */
    public static function randomElement(mixed $array = ['a', 'b', 'c'])
    {
        $elements = $array;
     ...
     */
    public static function randomKey(array $array = []): mixed
    {
        if (!$array) {
            return null;
        }
     ...
     */
    public static function shuffle(array|string $arg = '')
    {
        if (is_array($arg)) {
    ...
    private static function replaceWildcard(string $string, string $wildcard, $callback): string
    {
     ...
     * @return string
     */
    public static function asciify(string $string = '****'): mixed
    {
     ...
     * @return string
     */
    public static function regexify(string $regex = ''): mixed
    {
        // ditch the anchors
     ...
     * @return mixed|null
     */
    public function optional(float|int $weight = 0.5, mixed $default = null): ChanceGenerator
    {
        ...
        return $this->generator->optional($weight, $default);
    }
