...
final class BiasedTest extends TestCase
{
    ...
    {
        $this->performFake(['\Fejker\Provider\Biased', 'unbiased']);
    ...
    {
        $this->performFake(['\Fejker\Provider\Biased', 'linearHigh']);
    ...
    {
        $this->performFake(['\Fejker\Provider\Biased', 'linearLow']);
