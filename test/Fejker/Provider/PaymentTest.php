...
use Fejker\Calculator\Iban;
use Fejker\Calculator\Luhn;
use Fejker\Provider\Base as BaseProvider;
use Fejker\Provider\DateTime as DateTimeProvider;
use Fejker\Provider\Payment as PaymentProvider;
use Fejker\Provider\Person as PersonProvider;
...
final class PaymentTest extends TestCase
{
    ...
    public function testBankAccountNumber($locale): void
    {
        ...
        // Test format
        self::assertMatchesRegularExpression(self::$ibanFormats[$countryCode], $iban);
