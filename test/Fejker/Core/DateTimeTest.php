...
final class DateTimeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->extension = $this->faker->ext(DateTimeExtension::class)->withTimeZone(new \DateTimeZone('UTC'));
    }
    ...
    public function testDateTime(): void
    {
        ...
        self::assertEquals(new \DateTime('1990-09-29T12:12:53', new \DateTimeZone('UTC')), $dateTime);
    }
    ...
    public function testDateTimeAD(): void
    {
        ...
        self::assertInstanceOf(\DateTime::class, $dateTime);
        self::assertEquals(new \DateTime('1166-06-01T17:43:42', new \DateTimeZone('UTC')), $dateTime);
    }
    ...
    public function testDateTimeBetween(): void
    {
        ...
        self::assertInstanceOf(\DateTime::class, $dateTime);
        self::assertEquals(new \DateTime('2002-04-17T09:33:38', new \DateTimeZone('UTC')), $dateTime);
    }
